...
<div class="container">
    <div id="register">
        <form class="form-horizontal" id="RegistForm" method="post" action="register2" enctype="multipart/form-data">
            <fieldset>
                <div id="legend" class="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="email" placeholder="请填写邮箱地址..." class="form-control"
                               id="email" name="mail" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">验证码</label>
                    <div class="col-sm-6">
                        <input type="text" name="code" id="code" placeholder="请输入邮箱验证码..."
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="register1" class="btn btn-success">改为手机注册</a>
                        <input class="btn btn-info" type="submit" id="submit" value="邮箱注册" />
                    </div>
                </div>
            </fieldset>
        </form>
